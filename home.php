  ...
  <div class="padding text-center" style="margin-top: 0px;">
    <li>
      ...
      <div class="row g-4">
        ...
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img
              ...
              class="card-img-top" alt="Another" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Another</h5>
              <p class="card-text">Yukito Ayatsuji</p>
              <p class="card-text">Horror, School Life</p>
              <a href="another.php" class="btn btn-outline-light" style="margin-top: 25px">Baca</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img src="https://comicvine.gamespot.com/a/uploads/scale_small/6/67663/7304828-24.jpg" class="card-img-top"
              alt="Black Clover" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Black Clover</h5>
              <p class="card-text">Yuki Tabata</p>
              <p class="card-text">Action, Comedy</p>
              <a href="blackclover.php" class="btn btn-outline-light" style="margin-top: 50px">Baca</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img src="https://i.pinimg.com/736x/a0/9b/2e/a09b2eca90d800a22c62d50fbeb8ea48.jpg" class="card-img-top"
              alt="Jujutsu Kaisen" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Jujutsu Kaisen</h5>
              <p class="card-text">Gege Akutami</p>
              <p class="card-text">Action</p>
              <a href="jujutsu.php" class="btn btn-outline-light" style="margin-top: 50px">Baca</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img
              ...
              class="card-img-top" alt="One Piece" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">One Piece</h5>
              <p class="card-text">Eiichiro Oda</p>
              <p class="card-text">Action</p>
              <a href="onepiece.php" class="btn btn-outline-light" style="margin-top: 50px">Baca</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img src="https://upload.wikimedia.org/wikipedia/id/c/c3/OnePunchMan_manga_cover.png" class="card-img-top"
              alt="One Punch Man" width="250px" height="250px" />
            <div class="card-body">
        ...
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img src="https://i1.wp.com/halcyonrealms.com/blogpics/slamdunknew09.jpg?resize=500%2C780"
              class="card-img-top" alt="Slam Dunk" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Slam Dunk</h5>
              <p class="card-text">Takehiko Inoue</p>
              <p class="card-text">Sport, Comedy, School Life</p>
              <a href="slamdunk.php" class="btn btn-outline-light" style="margin-top: 25px">Baca</a>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img src="https://luminousscans.com/wp-content/uploads/2021/05/chroCover02.png" class="card-img-top"
              alt="Chronicles of Heavenly" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Chronicles of Heavenly</h5>
              <p class="card-text">Il-Hwang, Gom-Guk</p>
              <p class="card-text">Action, Drama</p>
              <a href="CoH.php" class="btn btn-outline-light" style="margin-top: 3px">Baca</a>
            </div>
          </div>
        </div>
        <div class="col">
          <div class="card text-bg-dark" style="width: 10rem; height: 500px">
            <img
              ...
              class="card-img-top" alt="Martial God Asura" width="250px" height="250px" />
            <div class="card-body">
              <h5 class="card-title">Martial God Asura</h5>
              <p class="card-text">修罗武神</p>
              <p class="card-text">Action, Romance</p>
              <a href="MGA.php" class="btn btn-outline-light" style="margin-top: 25px">Baca</a>
            </div>
          </div>
        </div>
      </div>
